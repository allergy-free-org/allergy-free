      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="space-y-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Asma bronquial, rinitis alérgica, sinusitis</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Reacciones a leche, huevo, frutos secos, mariscos</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Antibióticos, analgésicos, anestésicos</p>
                    </div>
                  </div>
                </div>
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    <TestTube className="w-5 h-5 text-blue-600 mt-1" />
                    <div>
                      <h4 className="font-semibold">Urticarias y Dermatitis</h4>
                      <p className="text-gray-600 text-sm">Eccema, dermatitis atópica, urticaria crónica</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <Heart className="w-5 h-5 text-blue-600 mt-1" />
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Hinchazón de labios, párpados, garganta</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <Shield className="w-5 h-5 text-blue-600 mt-1" />
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Oculares, picaduras, látex, químicos</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <CardContent>
              <div className="space-y-6">
                <Collapsible>
                  ...
                  <CollapsibleContent className="p-4 border-l-4 border-blue-600 bg-blue-50 mt-2">
          ...
          <Card className="bg-blue-50 border-blue-200">
            <CardHeader>
              <CardTitle className="text-2xl text-blue-800">Promociones Especiales</CardTitle>
              <CardDescription className="text-blue-700">Consulta nuestras ofertas actuales</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="bg-white p-6 rounded-lg">
                ...
                <Link href="/reservar">
                  <Button className="bg-blue-600 hover:bg-blue-700">Consultar Precio</Button>
                </Link>
              </div>
            </CardContent>
          </Card>
